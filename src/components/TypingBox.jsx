...
export const TypingBox = () => {
  ...
  return (
    <div className="z-10 max-w-[600px] flex space-y-6 flex-col bg-gradient-to-tr  from-slate-300/30 via-gray-400/30 to-slate-600-400/30 p-4  backdrop-blur-md rounded-xl border-slate-100/30 border">
      <div>
        <h2 className="text-white font-bold text-xl">How to say in Swedish?</h2>
        <p className="text-white/65">
          Type a sentence you want to say in Swedish and{" "}
          <span className="text-lime-500">Lärare </span>
          <span className="text-orange-500">Ai </span>
          <span className=" text-sky-500">Pro </span> will translate it for you.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="gap-3 flex">
          <input
            ...
            placeholder="Have you ever been to Sverige ?"
            value={question}
