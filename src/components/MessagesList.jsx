      ...
      {messages.length === 0 && (
        <div className="h-full w-full grid place-content-center text-center p-6">
          <h2 className="text-8xl font-bold text-white/90 italic ">
            ...
            <br />
            <span className="text-7xl mt-10">Swedish Language School</span>
          </h2>
          <h2 className="text-7xl font-bold font-jp text-orange-400/90 italic my-8">
          Lärare ai pro svenska språkskola
          </h2>
        </div>
      )}
        ...
        <div key={i}>
          <div className="flex">
            <div className="flex-grow">
              ...
              {renderSwedish(message.answer.swedish)}
            </div>
